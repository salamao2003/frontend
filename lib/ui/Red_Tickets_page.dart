...
class RedTicketsPage extends StatefulWidget {
  @override
  _RedTicketsPageState createState() => _RedTicketsPageState();
}

class _RedTicketsPageState extends State<RedTicketsPage> {
                              ...
                              children: [
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'Premium Ticket #${ticket['ticket_number']}',
                                        style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 18,
                                        ),
